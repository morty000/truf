...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="${ctx}/backend/static/h-ui.admin/skin/default/skin.css" id="skin"/>
    <link rel="stylesheet" type="text/css"
    ...
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl">
            <a class="logo navbar-logo f-l mr-10 hidden-xs"
               href="/aboutHui.shtml">TRUF.admin</a> <a
                class="logo navbar-logo-m f-l mr-10 visible-xs"
                href="/aboutHui.shtml">TRUF</a> <span
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="category_list.html" data-title="分类管理"
            ...
            <dl id="menu-product">
                ...
                <dd>
                    <ul>
                        <li><a data-href="product_list.html" data-title="商品管理"
                               href="javascript:void(0)">商品管理</a></li>
                        <li><a data-href="product_list_sell.html" data-title="在售商品管理"
                               href="javascript:void(0)">在售商品管理</a></li>
                        <li><a data-href="product_list_nosell.html" data-title="已下架商品"
                               href="javascript:void(0)">已下架商品</a></li>
                        <li><a data-href="product_list_del.html" data-title="已删除商品"
                               href="javascript:void(0)">已删除商品</a></li>
                        <li><a data-href="product_list_stock.html" data-title="库存不足商品"
                               href="javascript:void(0)">库存不足商品</a></li>
                    </ul>
                </dd>
            </dl>
            <dl id="menu-member">
                ...
                <dd>
                    <ul>
                        <li><a data-href="order_list.html" data-title="订单列表"
...
<script type="text/javascript"
        src="../../backend/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
<script type="text/javascript">
    $(function () {
