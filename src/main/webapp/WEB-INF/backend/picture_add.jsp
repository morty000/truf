...
<div class="page-container">
    <input type="hidden" id="id_1" value="${sessionScope.product.subImages}">
    <input type="hidden" id="id_2" value="${sessionScope.product.id}">
    <input type="hidden" id="id_3" value="${sessionScope.product.name}">
    <input type="hidden" id="id_4" value="${sessionScope.product.categoryId}">
    <input type="hidden" id="id_5" value="${sessionScope.product.detail}">
    <input type="hidden" id="id_6" value="${sessionScope.product.price}">
    <input type="hidden" id="id_7" value="${sessionScope.product.stock}">
    ...
    <form class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button id="btn" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i>
                    保存并提交审核
                </button>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${ctx}/backend/lib/jquery.validation/1.14.0/jquery.validate.js"></script>
<script type="text/javascript" src="${ctx}/backend/lib/jquery.validation/1.14.0/validate-methods.js"></script>
<script type="text/javascript" src="${ctx}/backend/lib/jquery.validation/1.14.0/messages_zh.js"></script>
<script type="text/javascript" src="${ctx}/backend/lib/webuploader/0.1.5/webuploader.min.js"></script>
    ...
    $(function () {
        $("#btn").click(function () {
            if ($(".imgWrap img").length > 0) {
                if (confirm("确认添加商品图片吗？")) {
                    var id = $("#id_2").val();
                    var images = $("#id_1").val();
                    var name = $("#id_3").val();
                    var categoryId = $("#id_4").val();
                    var detail = $("#id_5").val();
                    var price = $("#id_6").val();
                    var stock = $("#id_7").val();
                    $.ajax({
